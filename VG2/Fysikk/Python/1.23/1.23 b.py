...
t_verdier = []  # liste med verdier for tid
...
print("Løperen bruker: ", t, " sekunder på 100m")

plt.plot(t_verdier, s_verdier)              # lager grafen
plt.title("posisjon som funksjon av tid")   # tittel på grafen
plt.xlabel("$t$ (sek)")                     # x-akse-tittel
